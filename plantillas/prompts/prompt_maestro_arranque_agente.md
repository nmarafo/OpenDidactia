...
> Pega este prompt indicando nivel, materia y CCAA (Ej.: *2º ESO Música Canarias*, *3º Primaria Matemáticas Madrid*, *1º Bachillerato Filosofía Andalucía*, *4º ESO Física y Química Galicia*...) para diseñar en OpenDidactia. Optimizado para Google NotebookLM (< 10.000 caracteres).
