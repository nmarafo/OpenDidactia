...
> *Nota:* Para **Formación Profesional (FP)**, utilicen [`prompt_maestro_arranque_agente_fp.md`](prompt_maestro_arranque_agente_fp.md). Para **Enseñanzas de Régimen Especial (ERE)**, utilicen [`prompt_maestro_arranque_agente_ere.md`](prompt_maestro_arranque_agente_ere.md).
