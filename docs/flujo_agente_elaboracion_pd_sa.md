...
```text
[ 📌 PASO 0: Datos de Partida y Consulta de Objetivos/Planes de Centro (DESDE EL INICIO) ]
                                │
                                ▼
...
[ PASO 9: Herramienta Canvas de Calificación y Seguimiento Interactivo ]
                                │
...
## PASO 3: Base de Conocimiento y Ecosistema de Herramientas

Para planificar la secuencia anual y las sesiones diarias, el agente debe activar e integrar:
1. **Calendario Escolar y Efemérides de Canarias:** Integrar fechas significativas (Día de Canarias, Día de las Letras Canarias, Día de los Parques Nacionales, etc.).
2. **Rutinas de Pensamiento:** *Veo-Pienso-Me Pregunto, 3-2-1 Puente, Palabra-Idea-Frase, Círculo de Puntos de Vista, Comparar-Contrastar, Antes pensaba - Ahora pienso*.
3. **Técnicas Metodológicas Activas:** *Flipped Classroom, Design Thinking, Estaciones de Aprendizaje, Aprendizaje y Servicio (ApS), Rompecabezas (Jigsaw), Folio Giratorio*.
4. **Fases de David Merrill para el Diseño Instruccional:**
...
5. **Planes y Programas del Centro:** Integración con el PIDAS (Red Canaria InnovAS), plan de lectura, sostenibilidad y convivencia.

---

## 📌 CONSULTA INICIAL (OPCIONAL DESDE EL INICIO): OBJETIVOS Y PLANES DE CENTRO

La articulación con los Objetivos Prioritarios del Centro y sus Planes y Programas Institucionales es **OPCIONAL y se consulta desde el inicio del proceso** (en la toma de datos de partida):

> *"¿Deseas incorporar a la programación anual los Objetivos Prioritarios del Centro (PEC/PGA) o Planes y Programas Institucionales (PIDAS/InnovAS, Sostenibilidad, Igualdad, Plan Digital), o prefieres omitirlos y basarte exclusivamente en el currículo oficial ordinario?"*
...
## PASO 9: Herramienta de Calificación y Seguimiento Canvas

El agente debe generar o estructurar la lógica para registrar y hacer seguimiento del aprendizaje:
* **En Infantil:** Escala cualitativa oficial obligatoria (**Poco adecuado [PA]**, **Adecuado [AD]**, **Muy adecuado [MA]**, **Excelente [EX]**). No calcular medias aritméticas; mostrar historial de progresión cualitativa para un juicio global final.
* **En Primaria, ESO y Bachillerato:** Registro criterial por ponderación de instrumentos de evaluación vinculados a las rúbricas oficiales, calculando la nota trimestral y final a través de la media ponderada de los criterios y su proyección en las Competencias Clave.

> **Salida Documental Final:** Preguntar al usuario si desea compilar la aplicación interactiva autocontenida HTML/JS para el cuaderno de notas o el resumen global de la programación.
