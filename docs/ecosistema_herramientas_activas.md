# 🧰 Ecosistema de Herramientas Pedagógicas y Metodológicas Activas (Canarias)

Este catálogo reúne las herramientas didácticas, dinámicas de grupo, rutinas de pensamiento y principios instruccionales requeridos para el diseño de Situaciones de Aprendizaje y Programaciones Didácticas según las directrices oficiales de Canarias.

---

## 1. Los Cinco Principios Instruccionales de David Merrill

El modelo de David Merrill estructura la secuencia cognitiva de aprendizaje activo en cinco fases concatenadas:

```text
               ┌───────────────────────────────┐
               │    1. PROBLEMA / TAREA REAL   │
               └───────────────┬───────────────┘
                               │
       ┌───────────────────────┼───────────────────────┐
       ▼                       ▼                       ▼
┌──────────────┐        ┌──────────────┐        ┌──────────────┐
│ 2. ACTIVACIÓN│ ─────► │3.DEMOSTRACIÓN│ ─────► │4. APLICACIÓN │
└──────────────┘        └──────────────┘        └──────────────┘
                               │
                               ▼
                        ┌──────────────┐
...
1. **Problema / Tarea Central (Problem-Centered):** El aprendizaje se facilita cuando los estudiantes se enfrentan a la resolución de problemas auténticos del mundo real o retos significativos.
2. **Activación (Activation):** Se conecta con los conocimientos y experiencias previas del alumnado, sirviendo como andamiaje para la nueva información.
3. **Demostración / Modelado (Demonstration):** El docente o los recursos modelan la destreza o concepto en acción, mostrando ejemplos y contraejemplos claros.
4. **Aplicación Práctica (Application):** El estudiante aplica activamente los nuevos saberes para resolver problemas, recibiendo retroalimentación formativa y andamiaje gradual decreciente.
5. **Integración y Transferencia (Integration):** El alumnado transfiere, defiende y socializa sus aprendizajes en nuevos contextos de su entorno cotidiano.
...
* **PALABRA - IDEA - FRASE:** Tras la lectura de un texto histórico, científico o literario canario, cada alumno selecciona una palabra clave, una idea nuclear y una frase que resuma el impacto del texto.
...
* **FOLIO GIRATORIO:** Un único folio y rotulador rota por el equipo. Cada miembro aporta por turnos una idea, solución o elemento del proyecto mientras los demás supervisan y apoyan.
* **1 - 2 - 4:** Ante un reto, cada estudiante reflexiona y redacta individualmente su respuesta (1); luego consensúa con su pareja (2); finalmente, las dos parejas forman el cuarteto para acordar la solución definitiva del equipo (4).
